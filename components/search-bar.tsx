          ...
          <div className="group flex items-center border-b border-white/[0.08] pb-5 transition-colors focus-within:border-white/20 sm:pb-6">
            ...
            >
              ...
              <input
                ...
                className="w-full bg-transparent py-1 text-3xl font-medium tracking-tight text-text placeholder:text-text-tertiary outline-none sm:text-5xl disabled:opacity-40"
              />
            </div>
